...
|  outputResolution   |                       ['480p', '720p', '1080p', '1440p', '2160p', '4320p']                        |            not set / missing            | Sets the output resolution of the recordings to a fixed resolution. If not set / missing uses the resolution of the LoL ingame window.                                                                                                                                                     |
